...
Background::Background(void)
{
	...
	// Tiles
	if (!tileSpriteSheet.loadFromFile("Content/Images/Tileset_SpriteSheet_Layer3.png")) {
	...
	LoadMap("Content/Levels/1/layer3.txt");
...
Tile Background::LoadTile(char tileType, int x, int y) {
